...
{
    protected $rule = [
        'user_phone|手机号' =>'require',
        'user_password|密码' =>'require|length:6,12',
    ...
    protected $message = [
        ...
        'user_password.length'=>'密码长度必须在6-12位之间',
    ...
    protected $scene = [
        ...
        'reg'  =>  ['user_phone','user_password','user_repassword','user_nickname']
    ];
}
?>